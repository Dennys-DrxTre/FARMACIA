...
class Solicitud(models.Model):
    ...
    id_producto = models.ManyToManyField(
        Producto, verbose_name='Producto', through='DetalleSolicitud')  # Usando through para la relación muchos a muchos
    ...
    proceso_actual = models.CharField(
        'Proceso Actual', max_length=50, default='ATENCION AL CLIENTE'
    )
    estado = models.CharField(
        'Estado de la Solicitud', max_length=50, default='EN PROCESO', blank=False, null=False)
    aceptaciones = models.PositiveIntegerField(default=0)

    def actualizar_estado(self):
        if self.aceptaciones >= 3:
...
class DetalleSolicitud(models.Model):
    ...
    cantidad = models.PositiveIntegerField(default=1)  # Cambiar a un campo de cantidad
