# Generated by Django 5.0.1 on 2024-03-11 09:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen1', models.ImageField(default='images/slide1.jpg', upload_to='landing_images')),
                ('imagen2', models.ImageField(default='images/slide2.jpg', upload_to='landing_images')),
                ('imagen3', models.ImageField(default='images/slide3.jpg', upload_to='landing_images')),
                ('imagen4', models.ImageField(default='images/slide4.jpg', upload_to='landing_images')),
                ('imagen5', models.ImageField(default='images/slide5.jpg', upload_to='landing_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proceso_actual', models.CharField(default='ATENCION AL CLIENTE', max_length=50, verbose_name='Proceso Actual')),
                ('estado', models.CharField(default='EN PROCESO', max_length=50, verbose_name='Estado de la Solicitud')),
                ('aceptaciones', models.PositiveIntegerField(default=0)),
                ('cod_pac', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Project.paciente', verbose_name='Paciente')),
                ('id_producto', models.ManyToManyField(through='Project.DetalleSolicitud', to='Project.producto', verbose_name='Producto')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='solicitud',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Project.solicitud'),
        ),
        migrations.CreateModel(
