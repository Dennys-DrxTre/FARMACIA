...
urlpatterns = [
    ...
    path('edit/', login_required(views.edit_landing), name='edit_landing'),  # Ruta para editar el contenido del landing page
    ...
    path('estadoSolicitud/<int:pk>/', login_required(EstadoSolicitud.as_view()), name="estado_Solicitud"),
